export const enum ScriptOpcode {
    ...
    ITEMSPAWN_OPEN, // custom dev tool
    ITEMSPAWN_PAGE, // custom dev tool
    ITEMSPAWN_ADD // custom dev tool
}
...
export const ScriptOpcodeMap: Map<string, number> = new Map([
    ...
    ['ITEMSPAWN_OPEN', ScriptOpcode.ITEMSPAWN_OPEN],
    ['ITEMSPAWN_PAGE', ScriptOpcode.ITEMSPAWN_PAGE],
    ['ITEMSPAWN_ADD', ScriptOpcode.ITEMSPAWN_ADD],
